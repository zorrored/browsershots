**This documentation is for the development version 0.4 of Browsershots (based on [Django](http://www.djangoproject.com/)).** The documentation for the old stable version 0.3 is [here](InstallServerOld.md).
