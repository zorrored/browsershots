...
python shotserver04/manage.py sqlclear screenshots requests browsers factories | psql shotserver04

# Create all tables from Django models.
python shotserver04/manage.py syncdb factories browsers requests screenshots
